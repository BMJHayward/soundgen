...
INCPATH       = -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtMultimediaWidgets -isystem /usr/include/qt/QtMultimedia -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtXml -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
...
SOURCES       = histogramwidget.cpp \
		...
		playlistmodel.cpp \
		playercontrols.cpp \
		player.cpp moc_histogramwidget.cpp \
		moc_player.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents histogramwidget.h player.h playlistmodel.h playercontrols.h videowidget.h $(DISTDIR)/
	$(COPY_FILE) --parents histogramwidget.cpp videowidget.cpp playlistmodel.cpp playercontrols.cpp player.cpp $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_histogramwidget.cpp moc_player.cpp moc_playlistmodel.cpp moc_playercontrols.cpp moc_videowidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_histogramwidget.cpp moc_player.cpp moc_playlistmodel.cpp moc_playercontrols.cpp moc_videowidget.cpp
